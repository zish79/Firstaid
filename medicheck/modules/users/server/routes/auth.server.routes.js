...
module.exports = function (app) {
  ...
  //Setting up the user by BankId - Euorpe
  app.route('/api/auth/signinWithBankId').post(users.signinWithBankId);
  ...
  // Setting up the route for email verification
  app.route('/api/verification/:token').get(users.validateVerificationToken);
};
